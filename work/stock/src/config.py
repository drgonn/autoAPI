...
class DevelopmentConfig(Config):
	...
	SQL_DATABASE = os.environ.get('SQL_DATABASE') or "stock"
...
class TestingConfig(Config):
	...
	CELERY_RESULT_BACKEND = 'redis://localhost:6379/0'
	# Database configuration
	SQLALCHEMY_DATABASE_URI = os.environ.get('TEST_DATABASE_URL') or 		"mysql+pymysql://root:7811175yy@127.0.0.1:3306/test"
