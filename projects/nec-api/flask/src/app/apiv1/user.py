...
def list_user():
    ...
    if sorter:
        ...
        if sorter.get('updatedat') == 'ascend':
            total_users = total_users.order_by(User.updatedat.asc())
        elif sorter.get('updatedat') == 'descend':
            total_users = total_users.order_by(User.updatedat.desc())
        if sorter.get('createdat') == 'ascend':
            total_users = total_users.order_by(User.createdat.asc())
        elif sorter.get('createdat') == 'descend':
            total_users = total_users.order_by(User.createdat.desc())
        pass
